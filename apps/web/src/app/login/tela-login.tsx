...
export function TelaLogin() {
  ...
  /* sem personas cadastradas (base zerada) a tela fica só com o formulário */
  const comPersonas = personas.isError || !!personas.data?.length;
        ...
        <div className="rounded-[18px] bg-white p-7 text-[#0f172a] shadow-el-4">
          ...
          <form onSubmit={f.handleSubmit(entrar)} noValidate className="mt-3 grid gap-1.5">
            ...
            <Input
              ...
              placeholder={comPersonas ? 'persona.a@alumni.teste' : 'seu e-mail'}
              aria-invalid={!!erro}
              {...campoLogin}
              ref={(el) => {
                rLogin(el);
